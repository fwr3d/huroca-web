...
export default function AboutPage() {
  return (
    <>
      ...
      <section className="bg-cream border-t border-white/10 px-6 py-14 md:px-12 md:py-[88px]">
        <div className="max-w-[1344px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-start">
          <div>
            <p className="text-[#bc9347] text-base font-semibold tracking-[1px] mb-3">Why Lethbridge</p>
            <h2 className="font-heading text-dark text-3xl md:text-[40px] font-bold">
            [Placeholder: why Lethbridge headline]
            </h2>
          </div>
          <p className="text-dark text-base leading-relaxed md:mt-2">
          [Placeholder: why building in Lethbridge, Alberta matters — proximity to ranchers, feedlot conditions, local talent.]
          </p>
        </div>
      </section>

      <section className="bg-dark border-t border-white/[.08] px-6 py-14 md:px-12 md:py-[88px]">
        <div className="max-w-[1344px] mx-auto">

          <p className="text-gold text-base font-semibold tracking-[1px] mb-3">Our Journey</p>
          <h2 className="font-heading text-gold text-3xl md:text-[40px] font-bold mb-10 md:mb-14">
          Now, Next, Later
          </h2>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-6 gap-y-8">
            <div className="border-t-2 border-gold pt-5">
              <p className="text-gold text-[13px] font-bold mb-2">3 Weeks</p>
              <p className="text-cream/70 text-sm leading-relaxed">File provisional patent and complete in-lab testing.</p>
            </div>

            <div className="border-t-2 border-gold pt-5">
              <p className="text-gold text-[13px] font-bold mb-2">3 Months</p>
              <p className="text-cream/70 text-sm leading-relaxed">Prepare for in-field data collection.</p>
            </div>

            <div className="border-t-2 border-gold pt-5">
              <p className="text-gold text-[13px] font-bold mb-2">1 Year</p>
              <p className="text-cream/70 text-sm leading-relaxed">Run in-field pilot studies with feedlot partners.</p>
            </div>

            <div className="border-t-2 border-gold pt-5">
              <p className="text-gold text-[13px] font-bold mb-2">1 Year+</p>
              <p className="text-cream/70 text-sm leading-relaxed">Refinement and module addition.</p>
            </div>
      ...
      <section className="bg-cream border-t border-white/10 px-6 py-14 md:px-12 md:py-[88px]">
        <div className="max-w-[1344px] mx-auto">
          ...
          <h2 className="font-heading text-dark text-3xl md:text-[40px] font-bold mb-10 md:mb-14">
      ...
      <section className="bg-dark border-t border-white/[.08] py-14 px-6 md:py-20 md:px-12">
              <div className="max-w-[1344px] mx-auto">
                ...
                <h2 className="font-heading text-gold text-3xl md:text-[40px] font-bold mb-10 md:mb-14">The People Behind Huroca</h2>
      ...
      <section className="bg-dark border-t border-white/[.08] px-6 py-14 md:px-12 md:py-20">
        <div className="max-w-[1344px] mx-auto text-center">
          ...
          <h2 className="font-heading text-gold text-3xl md:text-[40px] font-bold mb-4">Our Mentors & Advisors</h2>
          <p className="text-cream/70 text-base max-w-[720px] mx-auto mb-10 md:mb-14 leading-relaxed">
